...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseGallery = __webpack_require__(1);
	...
	var Portfolio = function () {
	  ...
	  _createClass(Portfolio, [{
	    ...
	    value: function handleScroll() {
	      var coverIndex = Math.floor(window.pageYOffset / window.innerHeight);
	    ...
	    value: function handleCoverChange(index, indexWithClones) {
	      if (indexWithClones === this.coverIndex) return;

	      this.coverIndex = indexWithClones;
	    }
	  }, {
	    key: 'initCoverGallery',
	    value: function initCoverGallery() {
	      this.coverIndex = 0;
